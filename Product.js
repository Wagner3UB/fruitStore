...
//Creazione lista vetrina
  getListHome = () =>{
    ...
    const getListCreator = (item, index) => {
      ...
      + (item.price * item.itemToCart).toFixed(2) +'</p><p>€</p></li><li class="col-1 add_to_cart"><button id="addToCartButton" onclick="toCart('+ index +')"><span class="material-icons-outlined">add_shopping_cart</span></button></li></ul>'
    }
